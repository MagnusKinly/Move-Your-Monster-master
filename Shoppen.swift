...
class Shoppen: UIViewController {
  ...
  //  @IBOutlet weak var lblSundhedsPoint: UILabel!
    ...
    @IBAction func btnBanan(sender: UIButton) {
        ...
        var alertView = UIAlertController(title: "Shop", message: "Køb pære for 20 point?", preferredStyle: .Alert)
    ...
    @IBAction func btnStjerne(sender: UIButton) {
        var alertView = UIAlertController(title: "Shop", message: "Køb granatæble for 25?", preferredStyle: .Alert)
